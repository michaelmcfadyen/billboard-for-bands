...
@interface NXT : NSObject {
    ...
    /* ADDED BY NOT SAM */
    NSInteger leftTouch;
    NSInteger lightValue;
    NSInteger motorValue;
    NSInteger rightTouch;
    NSInteger prevLightValue;
    NSInteger numOfCycles;
}

/* ADDED BY SAM */
@property (nonatomic, assign) NSInteger leftTouch;
@property (nonatomic, assign) NSInteger rightTouch;
@property (nonatomic, assign) NSInteger lightValue;
@property (nonatomic, assign) NSInteger motorValue;
@property (nonatomic, assign) NSInteger prevLightValue;
@property (nonatomic, assign) NSInteger numOfCycles;
