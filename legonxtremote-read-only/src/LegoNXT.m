...
@synthesize motorValue;
@synthesize leftTouch;
@synthesize rightTouch;
@synthesize prevLightValue;
@synthesize numOfCycles;
...
/*
 * SAM METHOD - Exports the sensors values as an XML document
 */
- (void)exportXML {
    NSString *xml = [NSString stringWithFormat:@"<?xml version=\"1.0\" encoding=\"UTF-8\"?><sensor-data><sensors><light>%@</light><motor>%@</motor><lefttouch>%@</lefttouch><righttouch>%@</righttouch></sensors></sensor-data>",
                     [NSString stringWithFormat:@"%ld",(long)lightValue],
                     [NSString stringWithFormat:@"%ld",(long)motorValue],
                     [NSString stringWithFormat:@"%ld",(long)leftTouch],
                     [NSString stringWithFormat:@"%ld",(long)rightTouch]
                     ];
    NSString *filePath = [NSString stringWithFormat:@"/Applications/XAMPP/xamppfiles/htdocs/TeamBikeServer/sensor-data.xml"];
